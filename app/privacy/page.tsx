        ...
        <section className="privacy-policy" aria-label="隐私政策正文">
          <div className="privacy-policy-grid page-shell">
            <aside className="privacy-policy-summary">
              <h2>先说明当前网站的实际情况</h2>
              <p>当前公开网站以信息展示为主。加入意向表单会将您主动填写的称呼、专业方向和联系方式，通过邮件服务发送至指定联系人邮箱。</p>
              <p>当前表单不会自动创建 MVP 平台账号，也不会把申请写入模拟平台数据；联系人确认后再与您沟通后续安排。</p>
            ...
            <article className="privacy-policy-body">
              <section>
                <h2>一、适用范围</h2>
                <p>本政策适用于您访问匠应达网站、提交加入意向，以及通过网站公布的电话、邮箱与我们联系的情形。对于第三方网站或服务，其信息处理规则由相应第三方另行说明。</p>
              </section>

              <section>
                <h2>二、我们可能处理的信息</h2>
                <h3>您主动提供的信息</h3>
                <p>当您提交加入意向或通过电话、邮箱联系我们时，可能会提供称呼、联系方式、专业方向、咨询内容及后续沟通记录。请只提供完成本次沟通所必需的信息，不要发送与事项无关的敏感个人信息。</p>
                <h3>网站运行产生的必要信息</h3>
              ...
              <section>
                ...
                <p>加入意向发送过程中，必要字段会由邮件服务提供方代为传输至指定联系人邮箱，不用于广告营销。</p>
              </section>
              ...
              <section>
                ...
                <p>如对本政策或个人信息处理有疑问、意见或权利请求，请联系上海澜栖椿文化创意有限公司：</p>
                <address>
                  <span>联系人：马经理</span>
